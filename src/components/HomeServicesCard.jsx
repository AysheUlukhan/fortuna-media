        ...
        <div className='pt-4 service-card'>
            <div className='container'>
                <div className="row row-gap-4">
                    <NavLink to={'/servicesDetail'} className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 banner-card">
                        <img src={imageOne} alt="" className="d-block mx-lg-auto img-fluid w-100" />
                        <div className='banner-text'>
                            <h6>Dizayn</h6>
                        </div>
                    </NavLink>
                    <NavLink className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 banner-card">
